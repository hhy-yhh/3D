...
# Set up random seeds for reproducibility--设置随机种子以确保结果可复现
def setup_rng(rank):
...
def main(local_rank, cfg):
    # Set up distributed training--设置分布式训练
...
if __name__ == '__main__':
    ...
    # Prepare output directory--准备输出目录
    if cfg.node_rank == 0:
