...
#这个文件定义了一个名为TextConditionedMixin的混入类，用于文本条件化模型。
#该类提供了初始化文本条件化模型、编码文本以及获取条件数据的方法。它使用了Hugging Face的transformers库中的CLIPTextModel和AutoTokenizer来处理文本输入，并将其转换为嵌入向量，以便在训练和推理过程中使用。
